...
public class verifyPhone_register_copy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_code.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                makeRegisterRequest("yahya","781425511","yahya@gmail.com","string");
...
/////////////////////////////////
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationFailed(FirebaseException e) {
            Toast.makeText(verifyPhone_register_copy.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status) {
                        Session_management sessionManagement = new Session_management(verifyPhone_register_copy.this);
                        sessionManagement.createLoginSession(finalUser_uid,email,name, finalUser_phone,"","","","","",password, statusu , "0");
                        Toast.makeText(verifyPhone_register_copy.this,"تم بنجاح تسجيل حساب جديد", Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(verifyPhone_register_copy.this,MainActivity.class);
                        startActivity(i);
                        finish();
                        ...
                        Toast.makeText(verifyPhone_register_copy.this, "" + error, Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                    Toast.makeText(verifyPhone_register_copy.this, getResources().getString(R.string.connection_time_out), Toast.LENGTH_SHORT).show();
                }
            }
        });
