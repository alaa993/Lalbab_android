...
import com.lalbab.app.DawaActivity;
import com.lalbab.app.LoginActivity;
import com.lalbab.app.MainActivityDawa;
...
import com.lalbab.app.phoneVerfication;
...
public class Home_fragment extends Fragment implements UpdateHelper.onUpdateCheckListener  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv_items.setLayoutManager(new GridLayoutManager(getActivity(),1));
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent startlogin = new Intent(getActivity(), phoneVerfication.class);
        ...
        rv_items.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), rv_items, new RecyclerTouchListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                String getCat = category_modelList.get(position).getParentCat();

                String getcheckCat = category_modelList.get(position).getCheckCat();
                ...
                if(getid.equals("59")){
                    ...
                    Intent goDawa = new Intent(getActivity(), MainActivityDawa.class);
                    startActivity(goDawa);


                }else if(getcheckCat.equals("1")){

                    Bundle args = new Bundle();
                    Fragment fm = new CatSFragment();
