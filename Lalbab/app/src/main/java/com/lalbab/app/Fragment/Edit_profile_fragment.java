...
import com.lalbab.app.util.JSONParser;
import com.lalbab.app.util.NameValuePair;
...
public class Edit_profile_fragment extends Fragment implements View.OnClickListener {
    ...
    private TextView tv_phone, tv_name,  tv_house, tv_socity,btn_socity , et_phone;
...
//        String getsocity_name = sessionManagement.getUserDetails().get(BaseURL.KEY_SOCITY_NAME);
        ...
        if (!TextUtils.isEmpty(getimage)) {
            ...
            */
            ...
            Picasso.with(getActivity()).load(BaseURL.IMG_PROFILE_URL + getimage).into(iv_profile);
 ...
 /*       switch (item.getItemId()) {
            ...
            case R.id.action_change_password:
                com.lalbab.app.Fragment fm = new Change_password_fragment();
