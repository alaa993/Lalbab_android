...
/*
        ...
        */
        ...
        Picasso.with(activity).load(BaseURL.IMG_PRODUCT_URL +  map.get("product_image")).into(holder.iv_logo);
...
/*
    ...
    private void saveupdate(HashMap<String, String> map ,ProductHolder holder){
        dbHandler.setCart(map, Float.valueOf(holder.tv_contetiy.getText().toString()));
